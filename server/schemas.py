...
class ExerciseSchema(Schema):
    ...
    # Nested workouts, excluding the workout"s own "exercises" to avoid recursion.
    workouts = fields.List(
        fields.Nested(lambda: WorkoutSchema(exclude=("exercises", "workout_exercises"))),
        dump_only=True
    )
...
class WorkoutSchema(Schema):
    ...
    # Nested exercises, excluding the exercise"s own "workouts" to avoid recursion.
